    ...
    <AnimatePresence>
      {visible && activeTxn && (
        <motion.div
          ...
          className="fixed bottom-6 right-6 z-50 w-full max-w-sm rounded-none bg-[#09090B] text-white border border-[#E4E4E7]/10 p-5 shadow-[4px_4px_0px_rgba(9,9,11,0.2)]"
        >
