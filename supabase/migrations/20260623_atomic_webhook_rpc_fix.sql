-- First, drop ANY existing versions of this function to remove the ambiguous overloads
...
-- Recreate the function using 'text' for the timestamp parameter to prevent any
-- PostgREST type-casting ambiguity, and cast it internally to timestamptz.
